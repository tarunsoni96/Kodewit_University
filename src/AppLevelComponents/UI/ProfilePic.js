...
class ProfilePic extends Component {
  ...
  render() {
    ...
    let {size, style, showCameraIcon, canNavigateToProfile} = this.props;
    return (
      <UserInfoConsumer>
        {context => {
          let placeHolderImage =
            context.userData.gender == 'Male' ? require('assets/img/boy.png') : require('assets/img/girl.png');
          return (
            <TouchableOpacity
              onPress={() =>
                canNavigateToProfile ? this.navigateProfile() : this.tapFunc()
              }>
              <View
                style={[
                  styles.container,
                ...
                <Transition shared="profilePic">
                  <Image
                    ...
                    resizeMode="cover"
                    source={context.userData.pic_path ? {uri: context.userData.pic_path} : placeHolderImage}
                  />
                </Transition>
                {showCameraIcon && (
