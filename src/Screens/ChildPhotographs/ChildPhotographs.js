...
let data = [
  {
    uri:
      'https://images.theconversation.com/files/245935/original/file-20181116-194488-19it793.jpg?ixlib=rb-1.1.0&q=45&auto=format&w=496&fit=clip',
  },
  {
    uri:
      'https://cdn-01.belfasttelegraph.co.uk/incoming/article37346473.ece/ed9eb/AUTOCROP/w620h342/19238165-1.jpg',
  },
  {
    uri:
      'http://www.shipraamit.com/wp-content/uploads/2014/12/Child-Photography-Delhi-India-320x240.jpg',
  },
  {
    uri:
      'https://rukminim1.flixcart.com/image/704/704/poster/m/j/c/cute-baby-poster-2-pcs-poster-smiling-new-born-infant-child-love-original-imaea2epeytqj8wv.jpeg?q=70',
  },
  {
    uri:
  ...
  {
    uri:
      'https://c.ndtvimg.com/2018-10/r5ja5kds_girl-child_625x300_06_October_18.jpg',
  },
];
...
class ChildPhotographs extends Component {
  ...
  getData = () => {
    ...
    getChildPhotos(class_id, id, session)
      .then(resp => {
  ...
  renderItem = ({item, index}) => {
    if (item.image_path === 'blank') {
      ...
      return <PhotoItem uri={item.image_path} />;
    }
  };
          ...
          return (
            <>
              <Header>
                <View>
                  <SubHeader
                    title="Child Photographs"
                    type={Constants.header_back}
                  />
                </View>
              </Header>
              <NetworkAwareContent
